...
const projects: Project[] = [
  {
    title: "Под (NDA) - Дистанционное банковское обслуживание",
    ...
    duties: [
      ...
      "Реализация микрофронтов отвечающих за дистанционное банковское обслуживание при помощи React, RTK и MUI",
  ...
  },
  {
    ...
    duties: [
      ...
      "Создание таблиц с пагинацией при помощи Antd компонентов",
