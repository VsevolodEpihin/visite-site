        ...
        <div className="hero-contacts">
          <div className="contact-item">
            ...
            <span 
              ...
              onClick={() => copyToClipboard('@zzzsevazzz', 'telegram')}
              title="Нажмите чтобы скопировать"
            >
              @zzzsevazzz
              {copiedContact === 'telegram' && <span className="copy-indicator">✓ Скопировано!</span>}
            </span>
          </div>
          ...
          <div className="contact-item">
            ...
            <span 
              className="contact-value"
              onClick={() => copyToClipboard('epikhin01_03@mail.ru', 'email')}
              title="Нажмите чтобы скопировать"
            >
              epikhin01_03@mail.ru
              {copiedContact === 'email' && <span className="copy-indicator">✓ Скопировано!</span>}
            </span>
          </div>
          ...
          <div className="contact-item">
            ...
            >
              +7 (989) 613-58-50
              {copiedContact === 'phone' && <span className="copy-indicator">✓ Скопировано!</span>}
            </span>
          </div>
        </div>
      </div>
